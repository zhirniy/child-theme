...
?>
<form id="ajax-search-form" role="search" <?php echo $twentytwentyone_aria_label; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped above. ?> method="get" class="search-form search-form-custom" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    ...
    <input type="search" id="<?php echo esc_attr( $custom_id ); ?>" class="search-field custom-search-field" value="" name="s" autocomplete="off" />
